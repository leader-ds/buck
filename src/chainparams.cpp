...
public:
    CMainParams() {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BLOSSOM].nActivationHeight = 560000;
        consensus.vUpgrades[Consensus::UPGRADE_HEARTWOOD].nProtocolVersion = 170014;
        consensus.vUpgrades[Consensus::UPGRADE_HEARTWOOD].nActivationHeight = 560010;
        consensus.vUpgrades[Consensus::UPGRADE_CANOPY].nProtocolVersion = 170015;
...
public:
    CTestNetParams() {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BLOSSOM].nProtocolVersion = 170013;
...
public:
    CRegTestParams() {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BLOSSOM].nActivationHeight =
            Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_HEARTWOOD].nProtocolVersion = 170013;
